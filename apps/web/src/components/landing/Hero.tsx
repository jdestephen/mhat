    ...
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-slate-900 mb-8 max-w-4xl mx-auto leading-[1.1]">
          Take Control of Your Family's <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-blue-600">Health History.</span>
        </h1>
        
        <p className="text-xl text-slate-600 mb-10 max-w-2xl mx-auto leading-relaxed">
          Numa provides a secure, patient-controlled platform to manage your medical records, share data seamlessly with your doctors, and keep your entire family's health information in one place.
        </p>
